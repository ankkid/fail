...
≫ Aku Ga Jawab PM berarti lagi sibuk ≪
≫ ✰4teen12.id✰ ≪
              ...
              if op.param2 in Bots:
                ...
                pass
              	...
              	try:
                	...
                	cl.updateGroup(X)
                	cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\n" + "Kami Masukin Kedalam Blacklist Boss")
              ...
              ##if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Phantom buka qr","Phantom open qr"]:
                if msg.toType == 2:
        ...
        #-------------Fungsi Jam Update Finish-------------------#
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu Bang\nBaru Ketik Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"✰4teen12✰ Team Mau Bersih² Group Sampah Nih")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Iya Sepi kaya hati")
                ki2.sendText(msg.to,"􀜁􀅔Har Har􏿿")
                #ki3.sendText(msg.to,"Hinata pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["kicker"]:
                ki.sendText(msg.to,"Mana Kicker nya ?")
                ki2.sendText(msg.to,"mana sini biar gw sunat sampe abis")
                #ki3.sendText(msg.to,"Didik pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Mau bobok dulu","Tidur","Bobo dulu ah"]:
            ...
            elif msg.text in ["Hallo","Hai","Halo"]:
                ki.sendText(msg.to,"Hallo Juga ")
                ki2.sendText(msg.to,"Masih idup lu ? 􀜁􀅔Har Har􏿿")
                #ki3.sendText(msg.to,"Chomel pekok 􀜁􀅔Har Har􏿿")
            elif msg.text in ["Welcome","kam","wc"]:
                ki.sendText(msg.to,"Selamat datang di Group Kami")
                ki2.sendText(msg.to,"Jangan nakal ok!")
                ki3.sendText(msg.to,"Jangan Lupa Intro & Baca Rules")
            elif msg.text in ["Ijin left","Ijin Lep","Left"]:
                ki.sendText(msg.to,"Lah?, kok left ?")
                ki2.sendText(msg.to,"jangan left")
                ki3.sendText(msg.to,"Gruup sepi tanpa kehadiran mu")
            elif msg.text in ["Ijin left","Ijin Lep","Left"]:
                ki.sendText(msg.to,"Lah?, kok left ?")
                ki2.sendText(msg.to,"jangan left")
                ki3.sendText(msg.to,"Grup sepi tanpa kehadiran mu")
             elif msg.text in ["Kacang","kacang","di kacangin"]:
                ki.sendText(msg.to,"Mbal Panci, Mbal Panci, Kapur Barus, Racun Tikus nya Buuu....~")
                ki2.sendText(msg.to,"Mbal Panci, Mbal Panci, Kapur Barus, Racun Tikus nya Buuu....~")
                ki3.sendText(msg.to,"Mbal Panci, Mbal Panci, Kapur Barus, Racun Tikus nya Buuu....~")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping"]:
                ki.sendText(msg.to,"PONG !! 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
                ki2.sendText(msg.to,"PING !! PONG !! 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              #if msg.from_ in admin:
                cl.sendText(msg.to,"Tukang Cilok On")
                ki.sendText(msg.to,"Tukang Heckel On")
                ki2.sendText(msg.to,"Tukang Batagor On")
